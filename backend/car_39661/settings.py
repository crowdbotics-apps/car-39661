"""
Django settings for car_39661 project.
...
WSGI_APPLICATION = 'car_39661.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "car_39661 API",
    "DESCRIPTION": "API documentation for car_39661 App",
    "VERSION": "v1",
}
